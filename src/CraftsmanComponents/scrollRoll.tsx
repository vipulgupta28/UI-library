        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-black p-8">
            <div className="relative">
                <div className="relative w-96 bg-neutral-950 rounded-lg shadow-2xl overflow-hidden border border-white/10">
                        ...
                        >
                            <div 
                                className={`p-8 transition-all duration-1000 ${
                                    scrollHeight > 30 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                                }`}
                            >
                    ...
                    <div 
                        className={`h-12 border-t border-white/10 relative transition-all duration-500 ${
                            scrollHeight > 80 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                        }`}
                        style={{
                ...
                <div 
                    className={`absolute -left-3 bg-neutral-700 rounded-full shadow-lg transition-all duration-1000 ${
                        scrollHeight > 10 ? 'w-6 h-6 -top-1' : 'w-4 h-4 top-1'
                    }`}
                ></div>
                <div 
                    className={`absolute -right-3 bg-neutral-700 rounded-full shadow-lg transition-all duration-1000 ${
                        scrollHeight > 10 ? 'w-6 h-6 -top-1' : 'w-4 h-4 top-1'
                    }`}
                ></div>
                ...
                <div 
                    className={`absolute -left-3 bg-neutral-700 rounded-full shadow-lg transition-all duration-1000 ${
                        scrollHeight > 80 ? 'w-6 h-6 opacity-100' : 'w-4 h-4 opacity-0'
                    }`}
                    style={{
